...
from crawler.village_population import VillagePopulationStatsicParser
...
def main():
	...
	# 送資料
	population_statistic = VillagePopulationStatsicParser(url, url_id, [86, newest_year], [1, 12])
	population_statistic.craw_page()
